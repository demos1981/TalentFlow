            ...
            <div className="filters-grid">
              ...
              <div className="filter-group">
                <div className="custom-checkbox">
                  ...
                  />
                  <label htmlFor="remote-filter" className="checkbox-label">
                    <span className="checkbox-custom"></span>
                    <span className="checkbox-text">{t('remoteWorkOnly')}</span>
                  </label>
                </div>
              </div>
              ...
              <div className="filter-group">
                <div className="custom-checkbox">
                  <input
                    ...
                    className="checkbox-input"
                  />
                  <label htmlFor="urgent-filter" className="checkbox-label">
                    <span className="checkbox-custom"></span>
                    <span className="checkbox-text">{t('urgentJobs')}</span>
                  </label>
                </div>
              </div>
            </div>
