  ...
  const helpCategories: HelpCategory[] = [
    {
      ...
      description: 'Базові кроки для початку роботи з TalentFluent',
      articles: [
        {
          id: 'first-steps',
          title: 'Перші кроки',
          description: 'Як створити акаунт та налаштувати профіль',
          content: `# Перші кроки в TalentFluent
...
- HR системи`
  ...
  const faqItems: FAQItem[] = [
    {
      id: 'account-creation',
      question: 'Як створити акаунт в TalentFluent?',
    ...
    },
    {
      ...
      answer: 'TalentFluent пропонує різні тарифні плани. Базовий план дозволяє розміщувати до 5 вакансій безкоштовно. Для більшої кількості вакансій та розширених функцій доступні платні плани.',
      category: 'pricing',
    ...
    },
    {
      ...
      answer: 'TalentFluent використовує найсучасніші методи захисту даних: шифрування, двофакторна аутентифікація, регулярні аудити безпеки та відповідність GDPR. Ваші дані завжди захищені.',
      category: 'security',
    ...
    },
    {
      ...
      answer: 'Так, TalentFluent має мобільний додаток для iOS та Android. Додаток дозволяє управляти вакансіями, переглядати кандидатів та планувати інтерв\'ю з мобільного пристрою.',
      category: 'mobile',
