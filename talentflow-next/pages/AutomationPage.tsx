  ...
  return (
    <div className="dashboard-content">
      <div className="dashboard-header">
        <h1 className="dashboard-title">{t('automation')}</h1>
        <p className="dashboard-greeting-subtitle">{t('automationDescription')}</p>
      </div>
            ...
            {filteredWorkflows.map((workflow) => (
              <div key={workflow.id} className="workflow-card">
                ...
                <div className="workflow-details">
                  ...
                  <div className="detail-row">
                    <span className="detail-label">{t('executions')}:</span>
                    <span className="detail-value">{workflow.executionCount}</span>
                  </div>
                  <div className="detail-row">
                    <span className="detail-label">{t('successRate')}:</span>
