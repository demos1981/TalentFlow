  ...
  return (
    <div className="dashboard-content">
      <div className="dashboard-header">
        <h1 className="dashboard-title">{t('interviews')}</h1>
        <p className="dashboard-greeting-subtitle">{t('interviewsDescription')}</p>
      </div>
        ...
        <div className="interviews-filters">
          <div className="filters-left">
            <div className="search-box">
              ...
              <input
                type="text"
                placeholder={t('searchCandidatesJobs')}
                value={searchQuery}
            ...
            <div key={interview.id} className="interview-card">
              ...
              <div className="interview-details">
                <div className="detail-row">
                  ...
                  <div className="detail-item">
                    <Clock size={16} />
                    <span>{formatTime(interview.time)} ({interview.duration} {t('minutes')})</span>
                  </div>
                  <div className="detail-item">
                    {getTypeIcon(interview.type)}
                    <span>
                      {interview.type === 'video' ? t('video') : 
                       interview.type === 'phone' ? t('phone') : t('inPerson')}
                    </span>
                  </div>
                </div>
                ...
                <div className="detail-row">
                  <div className="detail-item">
                    <User size={16} />
                    <span>{t('interviewer')}: {interview.interviewer}</span>
                  </div>
                  <div className="detail-item">
                    <Briefcase size={16} />
                    <span>{t('stage')}: {interview.stage}</span>
                  </div>
                </div>
