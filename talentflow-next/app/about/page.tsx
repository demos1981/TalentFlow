...
export const metadata: Metadata = {
  title: 'Про нас - TalentFlow',
  description: 'Дізнайтеся більше про TalentFlow та нашу місію',
  keywords: 'про нас, команда, місія, цінності, TalentFlow',
  openGraph: {
    title: 'Про нас - TalentFlow',
    description: 'Дізнайтеся більше про TalentFlow та нашу місію',
    type: 'website',
      ...
      <main className="about-page">
        <div className="about-container">
          ...
          <section className="about-hero">
            <h2>Наша місія</h2>
            <p>
              TalentFlow - це AI-підсилена платформа, яка революціонізує процес найму персоналу. 
          ...
          <section className="about-story">
            <h2>Наша історія</h2>
            <p>
              Заснована в 2024 році, TalentFlow виникла з ідеї використати штучний інтелект 
