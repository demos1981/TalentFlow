            ...
            {notificationTypes.map((type) => (
              <div key={`email-${type.id}`} className="notification-item">
                ...
                <div className="custom-checkbox">
                  ...
                  />
                  <label htmlFor={`email-${type.id}`} className="checkbox-label">
            ...
            {notificationTypes.map((type) => (
              ...
              <div className="custom-checkbox">
                <input
                  ...
                  className="checkbox-input"
                />
                <label htmlFor={`push-${type.id}`} className="checkbox-label">
                  <span className="checkbox-custom"></span>
                  <span className="checkbox-text"></span>
                </label>
              </div>
            ...
            <div className="notification-item">
              ...
              <div className="custom-checkbox">
                <input
                  ...
                  className="checkbox-input"
                />
                <label htmlFor="sms-urgent" className="checkbox-label">
                  <span className="checkbox-custom"></span>
                  <span className="checkbox-text"></span>
                </label>
              </div>
            ...
            <div className="notification-item">
              ...
              <div className="custom-checkbox">
                <input
                  ...
                  className="checkbox-input"
                />
                <label htmlFor="sms-interview" className="checkbox-label">
                  <span className="checkbox-custom"></span>
                  <span className="checkbox-text"></span>
                </label>
              </div>
