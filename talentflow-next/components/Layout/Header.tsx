...
import { useSavedJobsCount } from '../../stores/savedJobsStore';
        ...
        <div className="header-user-menu" ref={profileRef}>
          <div className="header-user-menu-trigger" onClick={toggleProfile}>
            ...
            <span className="header-user-name">
              {user?.name || user?.firstName || user?.email || t('user')}
            </span>
          ...
          {isProfileOpen && (
            <div className="user-dropdown-menu">
              ...
              <Link
                ...
                onClick={() => setIsProfileOpen(false)}
              >
                <Star className="user-dropdown-icon" />
                {t('savedJobs')}
                {count > 0 && <span className="ml-2 text-xs bg-purple-100 text-purple-600 px-2 py-0.5 rounded-full">{count}</span>}
              </Link>
