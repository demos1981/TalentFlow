export const docsTranslations = {
  en: {
    ...
    completeApiDocumentationAndGuides: 'Complete TalentFluent API documentation and usage guides',
    ...
    overviewDescription: 'General information about TalentFluent API',
    ...
    // API content
    apiOverviewContent: 'TalentFluent API is a RESTful API for working with the HR platform. The API allows you to manage jobs, candidates, companies and other system entities.',
  ...
  uk: {
    ...
    completeApiDocumentationAndGuides: 'Повна документація TalentFluent API та гайди використання',
    ...
    // API sections
    overview: 'Огляд API',
    overviewDescription: 'Загальна інформація про TalentFluent API',
    ...
    // API content
    apiOverviewContent: 'TalentFluent API - це RESTful API для роботи з HR платформою. API дозволяє управляти вакансіями, кандидатами, компаніями та іншими сутностями системи.',
  ...
  es: {
    ...
    completeApiDocumentationAndGuides: 'Documentación completa de la API de TalentFluent y guías de uso',
    ...
    overviewDescription: 'Información general sobre la API de TalentFluent',
    ...
    // API content
    apiOverviewContent: 'La API de TalentFluent es una API RESTful para trabajar con la plataforma de RR.HH. La API permite gestionar empleos, candidatos, empresas y otras entidades del sistema.',
  ...
  pl: {
    ...
    completeApiDocumentationAndGuides: 'Kompletna dokumentacja API TalentFluent i przewodniki użytkowania',
    ...
    overviewDescription: 'Ogólne informacje o API TalentFluent',
    ...
    // API content
    apiOverviewContent: 'TalentFluent API to RESTful API do pracy z platformą HR. API pozwala zarządzać ofertami pracy, kandydatami, firmami i innymi encjami systemu.',
  ...
  de: {
    ...
    completeApiDocumentationAndGuides: 'Vollständige TalentFluent API-Dokumentation und Nutzungsleitfäden',
    ...
    overviewDescription: 'Allgemeine Informationen zur TalentFluent-API',
    ...
    // API content
    apiOverviewContent: 'Die TalentFluent-API ist eine RESTful-API für die Arbeit mit der HR-Plattform. Die API ermöglicht die Verwaltung von Stellen, Kandidaten, Firmen und anderen Systementitäten.',
  ...
  fr: {
    ...
    completeApiDocumentationAndGuides: 'Documentation complète de l\'API TalentFluent et guides d\'utilisation',
    ...
    overviewDescription: 'Informations générales sur l\'API TalentFluent',
    ...
    // API content
    apiOverviewContent: 'L\'API TalentFluent est une API RESTful pour travailler avec la plateforme RH. L\'API permet de gérer les emplois, les candidats, les entreprises et autres entités du système.',
  ...
  pt: {
    ...
    completeApiDocumentationAndGuides: 'Documentação completa da API TalentFluent e guias de uso',
    ...
    overviewDescription: 'Informações gerais sobre a API TalentFluent',
    ...
    // API content
    apiOverviewContent: 'A API TalentFluent é uma API RESTful para trabalhar com a plataforma de RH. A API permite gerenciar vagas, candidatos, empresas e outras entidades do sistema.',
  ...
  ru: {
    ...
    completeApiDocumentationAndGuides: 'Полная документация API TalentFluent и руководства по использованию',
    ...
    // API sections
    overview: 'Обзор API',
    overviewDescription: 'Общая информация об API TalentFluent',
    ...
    // API content
    apiOverviewContent: 'API TalentFluent — это RESTful API для работы с HR-платформой. API позволяет управлять вакансиями, кандидатами, компаниями и другими сущностями системы.',
  ...
  kk: {
    ...
    completeApiDocumentationAndGuides: 'TalentFluent API толық құжаттамасы және пайдалану нұсқаулықтары',
    ...
    // API sections
    overview: 'API Шолу',
    overviewDescription: 'TalentFluent API туралы жалпы ақпарат',
    authentication: 'Аутентификация',
    ...
    // API content
    apiOverviewContent: 'TalentFluent API — бұл HR платформасымен жұмыс істеуге арналған RESTful API. API жұмыстарды, үміткерлерді, компанияларды және жүйенің басқа да сутңдерін басқаруға мүмкіндік береді.',
  ...
  cs: {
    ...
    completeApiDocumentationAndGuides: 'Kompletní dokumentace API TalentFluent a průvodce použitím',
    ...
    overviewDescription: 'Obecné informace o API TalentFluent',
    ...
    // API content
    apiOverviewContent: 'TalentFluent API je RESTful API pro práci s HR platformou. API umožňuje spravovat práce, kandidáty, společnosti a další systémové entity.',
  ...
  az: {
    ...
    completeApiDocumentationAndGuides: 'TalentFluent API tam sənədləşməsi və istifadə bələdçiləri',
    ...
    // API sections
    overview: 'API İcmalı',
    overviewDescription: 'TalentFluent API haqqında ümumi məlumat',
    ...
    // API content
    apiOverviewContent: 'TalentFluent API HR platforması ilə işləmək üçün RESTful API-dir. API işləri, namizədləri, şirkətləri və digər sistem qurumlarını idarə etməyə imkan verir.',
