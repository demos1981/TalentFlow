# Архітектура TalentFlow

## Огляд

TalentFlow використовує Next.js App Router з правильною архітектурою для розділення серверних та клієнтських компонентів. Це забезпечує оптимальну SEO-оптимізацію та продуктивність.
