  ...
  const docSections: DocSection[] = [
    {
      ...
      description: 'Загальна інформація про TalentFlow API',
      content: `TalentFlow API - це RESTful API для роботи з HR платформою. API дозволяє управляти вакансіями, кандидатами, компаніями та іншими сутностями системи.
  ...
  return (
    <div className="dashboard-content">
      <div className="dashboard-header">
        <h1 className="dashboard-title">Документація API</h1>
        <p className="dashboard-greeting-subtitle">Повна документація TalentFlow API та гайди використання</p>
      </div>
                  ...
                  {activeSectionData.codeExample && (
                    <div className="code-example">
                      <div className="code-header">
                        <span>Приклад використання</span>
                        <button
