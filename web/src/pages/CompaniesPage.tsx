    ...
    <div className="dashboard-content">
      <div className="dashboard-header">
        <div className="dashboard-header-content">
          <h1 className="dashboard-title">Компанії</h1>
          <p className="dashboard-greeting-subtitle">
            Управління профілями компаній та партнерів
          </p>
        </div>
      </div>
        ...
        {companies.map((company) => (
          <div key={company.id} className="dashboard-section-card">
            ...
            <div className="company-details">
              ...
              <div className="company-stats">
                <div className="company-stat">
                  ...
                  <span>{company.employees} співробітників</span>
                </div>
                <div className="company-stat">
            ...
            <div className="company-actions">
              <button className="btn btn-primary">Переглянути профіль</button>
              <button className="btn btn-outline">Вакансії</button>
            </div>
          </div>
        ))}
      </div>
