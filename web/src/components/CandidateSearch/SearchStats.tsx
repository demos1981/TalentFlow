...
import { candidateService, SearchStats as SearchStatsType } from '../../services/candidateService';
      ...
      <div className="stats-grid">
              ...
              <div key={skill.name} className="skill-bar">
                ...
                <div className="skill-progress">
                  <div 
                    ...
                    style={{ 
                      width: `${(skill.count / Math.max(...stats.topSkills.map(s => s.count))) * 100}%`,
        ...
        <div className="stats-section location-distribution">
          ...
          <div className="location-chart">
            {stats.locationDistribution.slice(0, 6).map((location, index) => (
              <div key={location.location} className="location-item">
                ...
                <div className="location-progress">
                  <div 
                    ...
                    style={{ 
                      width: `${(location.count / Math.max(...stats.locationDistribution.map(l => l.count))) * 100}%`,
