...
export class DocsService {
  ...
  static async getErrorCodes(): Promise<ErrorCode[]> {
    const response = await apiClient.get('/docs/errors');
    return response.data.data;
  }
}
