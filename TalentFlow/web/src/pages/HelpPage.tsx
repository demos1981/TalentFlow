  ...
  return (
    <div className="dashboard-content">
      <div className="dashboard-header">
        <h1 className="dashboard-title">Допомога та підтримка</h1>
        <p className="dashboard-greeting-subtitle">Знайдіть відповіді на ваші питання та отримайте допомогу</p>
      </div>
      ...
      <div className="help-container">
        ...
        <div className="help-search">
          <div className="search-wrapper">
            ...
            <input
              type="text"
              placeholder="Пошук по допомозі та FAQ..."
              value={searchQuery}
        ...
        <div className="faq-section">
          <div className="faq-header">
            ...
            <p>Знайдіть відповіді на найпопулярніші питання</p>
          </div>
        ...
        <div className="support-section">
          <div className="support-header">
            ...
            <p>Зв\'яжіться з нашою командою підтримки</p>
          </div>
