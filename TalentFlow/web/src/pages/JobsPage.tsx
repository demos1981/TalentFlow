            ...
            {user?.role === 'employer' && (
              <button 
                ...
                onClick={() => {
                  ...
                  console.log('JobsPage: User canPostJobs:', user?.canPostJobs);
                  ...
                  <div key={job.id} className="job-card">
                    <div className="job-header">
                      <div className="job-title-section">
                        ...
                        <div className="job-company">{job.company || t('companyNotSpecified')}</div>
                      </div>
                    ...
                    <div className="job-details">
                      <div className="job-detail-item">
                        ...
                        {job.isRemote && <span className="remote-badge">{t('remoteBadge')}</span>}
                      </div>
                                             <div className="job-detail-item">
