...
import { USER_TYPES, CURRENCY_OPTIONS, INDUSTRY_OPTIONS, CITIES_UA, COUNTRIES, TOP_SKILLS, MAX_SKILLS_PER_JOB } from '../../../constants';
import { Briefcase, MapPin, Clock, DollarSign, FileText, Plus, X, Loader2, ExternalLink } from 'lucide-react';
...
const CreateJobPage: React.FC = () => {
  ...
  const getExperienceLevelsOptions = () => [
    { value: 'no_experience', label: t('noExperience') },
    { value: 'less_than_1', label: t('lessThan1Year') },
    { value: '1_to_3', label: t('from1To3Years') },
    { value: '3_to_5', label: t('from3To5Years') },
    { value: '5_to_10', label: t('from5To10Years') },
    { value: 'more_than_10', label: t('moreThan10Years') }
  ];
      ...
      <form onSubmit={handleSubmit} className="form-container">
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              <label htmlFor="industry" className="form-label">{t('industry')} *</label>
              <select
                id="industry"
                name="industry"
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <select
                ...
                required
              >
                {getJobTypesOptions().map(jobType => (
            ...
            <div className="form-group">
              ...
              <select
                ...
                required
              >
                {getExperienceLevelsOptions().map(level => (
            ...
            <div className="form-group">
              <div className="custom-checkbox">
                ...
                <label htmlFor="isFeatured" className="checkbox-label">
                  <span className="checkbox-custom"></span>
                  <span className="checkbox-text">{t('featured')}</span>
                </label>
              </div>
            </div>
          </div>
